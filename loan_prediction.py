...
#Droping ApplicantIncome and CoapplicantIncome
...
def eval_metrics(actual,pred):
    ...
    auc = metrics.auc(fpr_sorted, tpr_sorted)



    plt.figure(figsize=(8,8))
    plt.plot(fpr_sorted,tpr_sorted,color='blue',label='Roc curve area = %0.2f'%auc)
    plt.plot([0,1],[0,1],'r--')
    plt.xlim([-0.1,1.1])
    plt.ylim([-0.1,1.1])
